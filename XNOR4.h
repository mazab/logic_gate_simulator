...
class XNOR4:public Gate
{
public:

	//constructor & destructor:
	XNOR4();//when using this defolt constructor, You have to set the ApplicationManager and the Graphics info manualy
	XNOR4(const GraphicsInfo & r_GfxInfo, ApplicationManager* r_ApplicationManager);
	virtual ~XNOR4();
