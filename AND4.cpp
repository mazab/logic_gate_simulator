...
//Constructor:
AND4::AND4()
	:Gate("AND_4", AND_4,"images\\AND4.jpg", 4){}

AND4::AND4(const GraphicsInfo & r_GfxInfo, ApplicationManager* r_ApplicationManager)
	:Gate("AND_4", AND_4, r_GfxInfo, r_ApplicationManager, "images\\AND4.jpg", 4)
{
	Point* p1 = new Point;
