...
class NAND4:public Gate
{
public:

	//constructor & destructor:
	NAND4();//when using this defolt constructor, You have to set the ApplicationManager and the Graphics info manualy
	NAND4(const GraphicsInfo & r_GfxInfo, ApplicationManager* r_ApplicationManager);
	virtual ~NAND4();
