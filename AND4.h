...
public:
	...
	AND4();//when using this defolt constructor, You have to set the ApplicationManager and the Graphics info manualy
	AND4(const GraphicsInfo & r_GfxInfo, ApplicationManager* r_ApplicationManager);
	virtual ~AND4();
